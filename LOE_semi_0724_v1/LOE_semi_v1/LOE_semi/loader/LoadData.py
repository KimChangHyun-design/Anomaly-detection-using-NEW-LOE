...
def csagn(contamination_rate, true_anomaly_rate):
    data_path = 'DATA/csagn/'
    samples = np.load(data_path+'csagn_x.npy')# 1026
    labels = np.load(data_path+'csagn_y.npy')#1026
...
def lg_data_ntl_plus_v1(contamination_rate,true_anomaly_rate):
    # 제품의 csv 파일 입력 부분
...
def load_data(simu_,data_name,cls,contamination_rate=0.0, true_anomaly_rate=0.0):
    ...
    elif data_name == 'lg_data_ntl_plus_v1' :
        train, train_label, test, test_label,true_train_label = lg_data_ntl_plus_v1(contamination_rate,true_anomaly_rate)
    elif data_name == 'lg_data_ntl_plus_v2' :
        train, train_label, test, test_label,true_train_label = lg_data_ntl_plus_v1(contamination_rate,true_anomaly_rate)
