...
from models.NeutralAD import SeqNeutralAD,TabNeutralAD,FeatNeutralAD,VisNeutralAD
...
class Config:
    ...
    datasets = {
        ...
        'natops': natops,
        'simulation_data_ntl_plus' : simulation_data_ntl_plus,
        'lg_data_ntl_plus_v1':lg_data_ntl_plus_v1,
        'lg_data_ntl_plus_v2':lg_data_ntl_plus_v2,
        'csagn':csagn
    }
