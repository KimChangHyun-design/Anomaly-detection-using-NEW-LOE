...
class runExperiment():
    ...
    def run_test(self, train_data,val_data,test_data, logger,contamination,query_num):
        ...
        val_loss,val_auc,test_auc,test_ap,test_f1, test_p_c, test_p_f, test_th, test_score = \
        ...
        return val_auc, test_auc, test_ap,test_f1, test_p_c, test_p_f, test_th, test_score
